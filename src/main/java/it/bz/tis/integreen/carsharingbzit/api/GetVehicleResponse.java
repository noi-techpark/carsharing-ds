...
public class GetVehicleResponse
{
   ...
   it.bz.tis.integreen.dto.carsharing.CarsharingVehicleDto[] carsharingVehicleDto;

   public void setVehicle(it.bz.tis.integreen.dto.carsharing.CarsharingVehicleDto[] vehicle)
   {
